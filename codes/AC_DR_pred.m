...
% This function computes the asymptotic Algorithmic Complexity per prediction for the single Delta Rule model.
% NSP=1 --> Neural-Spiking P system implementation of the algorithm.
% NSP=0 --> Each operation counts 1.

function[f]=AC_DR_pred(NSP)
