...
% This function computes the asymptotic Algorithmic Complexity per estimation for the Mixture of Sliding Windows with N>1 units.
...
function[f]=AC_NSAs_estim(lopt,N,NSP)
...
if(NSP)
    ...
    f = AC_NSAs_pred(lopt,N,NSP) -(S+A+2*P) - 3*Mr  - Mm;
    ...
    f = AC_NSAs_pred(lopt,N,NSP) -(2*S+2*P) - 3*Mr  - Mm;
